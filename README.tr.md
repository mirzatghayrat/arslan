...
| <img src="docs/assets/icons/shield-check.svg" width="20"><br/>**Varsayılan olarak güvenli, sorumluluk reddiyle değil** | Üretilen kod macOS çekirdek sandbox’ında ağ erişimi olmadan çalışır; sandbox yoksa çalıştırılmaz. Belirli ağ komutları yalnızca sınırlı, herkese açık ve kimlik doğrulamasız aktarım kullanır. Kimlik bilgisi gerektiren depo ve hesap işlemleri, yalıtılmış aracı ve güvenlik kabulü tamamlanana kadar devre dışıdır. |
