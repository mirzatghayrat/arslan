...
describe("locale parity", () => {
  it("en locale has 1118 keys (baseline guard)", () => {
    ...
    // 954 → 1118: (b) dispatch cap — settings label/desc/unset, evolution.card.estimate_tokens,
    ...
    expect(enKeys).toHaveLength(1118);
  });
