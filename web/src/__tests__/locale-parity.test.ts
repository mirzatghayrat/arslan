...
describe("locale parity", () => {
  it("en locale has 1186 keys (baseline guard)", () => {
    ...
    // 954 → 1186: (b) dispatch cap — settings label/desc/unset, evolution.card.estimate_tokens,
    ...
    expect(enKeys).toHaveLength(1186);
  });
