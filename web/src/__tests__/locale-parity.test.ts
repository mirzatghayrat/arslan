...
describe("locale parity", () => {
  it("en locale has 1180 keys (baseline guard)", () => {
    ...
    // 954 → 1180: (b) dispatch cap — settings label/desc/unset, evolution.card.estimate_tokens,
    ...
    expect(enKeys).toHaveLength(1180);
  });
