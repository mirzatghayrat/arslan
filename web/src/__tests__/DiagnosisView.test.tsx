...
vi.mock("../api/client", () => ({ api: {
  ...
  // S3-M4: ... and the ScheduledTasksCard (own test file).
...
describe("DiagnosisView", () => {
  it("catalog → spawn detail → breadcrumb back to catalog", async () => {
    ...
    expect(bc.textContent).toContain("ui.diagnostics");
    fireEvent.click(screen.getByText("ui.diagnostics"));           // breadcrumb root → back to catalog
