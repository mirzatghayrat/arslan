...
export const PALETTE_TOKENS: Record<Palette, { light: ResolvedTokens; dark: ResolvedTokens }> = {
  current:  { light: { background:"#FAFBFC", surface:"#FFFFFF", foreground:"#0F172A", mutedForeground:"#64748B", primary:"#E57D1B", primaryForeground:"#1A0E00" }, dark: { background:"#0A0C10", surface:"#121622", foreground:"#FFFFFF", mutedForeground:"#94A3B8", primary:"#FF8E24", primaryForeground:"#1A0E00" } },
