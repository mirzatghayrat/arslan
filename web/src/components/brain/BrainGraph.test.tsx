...
describe("BrainGraph", () => {
  ...
  it("renders self / tag / ghost node kinds", async () => {
    const { container } = render(
      <BrainGraph focusedId={null} onFocus={noop} onPick={noop} onCreateNoteWithTitle={noop} />);
  ...
  it("double-clicking a ghost node asks to create that note", async () => {
    ...
    const { container } = render(
      <BrainGraph focusedId={null} onFocus={noop} onPick={noop} onCreateNoteWithTitle={onCreate} />);
