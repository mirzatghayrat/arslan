// Vendored from reactbits.dev (DavidHDev/react-bits) Backgrounds/Prism.
// Ported to TSX; shader/animation kept identical. Added: pause when the tab is
// hidden (battery), inline container sizing (no CSS file), className passthrough.
...
export default function Prism({
  ...
  useEffect(() => {
    ...
    // Pause when the tab is hidden (battery / GPU).
    const onVisibility = () => {
  ...
  return <div ref={containerRef} className={className} style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }} />;
}
