      ...
      {showLedgerModal && (
        <div id="spawns-ledger-modal" className="fixed inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="w-full max-w-4xl h-[80vh] bg-surface/95 border border-border-strong rounded-2xl shadow-2xl overflow-hidden shadow-primary/25 flex flex-col">
            ...
            <div className="px-6 py-2 bg-warning/10 border-b border-warning/20 flex items-center gap-2 text-[10px] font-mono text-warning/80 shrink-0">
              <span>⚠</span>
                ...
                return filtered.map((spawn) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className="px-3 py-1.5 rounded-lg text-[10px] font-mono font-bold uppercase tracking-wider border border-border/60 bg-background/60 text-subtle-foreground cursor-not-allowed opacity-50 shrink-0 flex items-center gap-1"
