...
<a href="https://github.com/mirzatghayrat/arslan/releases/latest/download/Arslan-macos-arm64.dmg"><img src="docs/assets/btn/zh-download.png" alt="下载 macOS 版" height="44"></a>&nbsp;&nbsp;<a href="https://mirzatghayrat.github.io/arslan/"><img src="docs/assets/btn/zh-website.png" alt="官网" height="44"></a>&nbsp;&nbsp;<a href="docs/QUICKSTART.md"><img src="docs/assets/btn/zh-quickstart.png" alt="快速上手" height="44"></a>&nbsp;&nbsp;<a href="docs/ARCHITECTURE.md"><img src="docs/assets/btn/zh-architecture.png" alt="架构" height="44"></a>&nbsp;&nbsp;<a href="SECURITY.md"><img src="docs/assets/btn/zh-security.png" alt="安全" height="44"></a>&nbsp;&nbsp;<a href="CONTRIBUTING.md"><img src="docs/assets/btn/zh-contributing.png" alt="参与贡献" height="44"></a>

<a href="README.md"><img src="docs/assets/btn/lang-en.png" alt="English" height="32"></a>&nbsp;<img src="docs/assets/btn/lang-zh-on.png" alt="简体中文" height="32">&nbsp;<a href="README.de.md"><img src="docs/assets/btn/lang-de.png" alt="Deutsch" height="32"></a>&nbsp;<a href="README.ja.md"><img src="docs/assets/btn/lang-ja.png" alt="日本語" height="32"></a>&nbsp;<a href="README.es.md"><img src="docs/assets/btn/lang-es.png" alt="Español" height="32"></a>&nbsp;<a href="README.tr.md"><img src="docs/assets/btn/lang-tr.png" alt="Türkçe" height="32"></a>
...
| <img src="docs/assets/icons/graduation-cap.svg" width="20"><br/>**带考试关卡的自我进化** | 分身的提示词会依据自己的运行历史自我修订——然后必须在留出的历史任务上、在*每一个*维度上都胜过在任版本。通过 → 一份清晰可读的 diff 送进你的收件箱。**在你按下 Promote 之前，任何改动都不会生效。** |
...
| <img src="docs/assets/icons/brain.svg" width="20"><br/>**带时间轴的第二大脑** | 资料、心得、个人档案和 `[[wiki-link]]` 笔记——FTS5 + 向量嵌入的混合检索，还能以 Obsidian 风格的力导向图浏览。每条认知都携带时间：何时成立、被什么取代，还有一个过滤器能让图谱回到过去任一时刻的模样。 |
| <img src="docs/assets/icons/badge-check.svg" width="20"><br/>**诚实是设计出来的** | 护栏会拦截“我已经做过了”这类凭空捏造，让 agent 的自我汇报始终与真实执行过的内容挂钩。模型提议的记忆删除/覆盖从不直接生效——它们会先落进收件箱，由你接受或驳回。 |
| <img src="docs/assets/icons/key-round.svg" width="20"><br/>**本地优先，自带密钥** | 你的机器、你的 API 密钥、跨多家供应商的质量优先路由——中间**没有任何第三方服务器**。开箱即带 6 种语言的 i18n 和 6 套主题配色（明暗双版）。 |
...
分身的提示词会被自动修订——但在你看到它之前，它必须先在留出的历史任务上证明自己。任何一个维度都不允许比在任版本得分更低。不通过 → 直接丢弃，永远不会浮出水面。通过 → 一张附带清晰可读 diff 的提案卡片；改动**只在你点击 Promote 时**才会落地。

## 带时间轴的第二大脑

<div align="center">
  <img src="docs/assets/fig03-second-brain.png" alt="FIG. 03——第二大脑：记忆自动形成，分身通过混合检索读取，模型的编辑须经你的收件箱，每条认知都携带时间" width="100%">
</div>
