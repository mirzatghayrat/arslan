...
> 状态:**待审**。上位 spec = `2026-09-02-realtime-voice.md`(三条建议已同意,V1a 已随 v0.1.36 出货,V1b 在 PR #81)。
...
## §9 尚无证据 / 要你拍板
- **要你拍板**:决策②(V2a 先出 —— 建议是)· 决策③(V2 不取消生成 —— 建议是)· `voice_mode` 默认值(建议 `push_to_talk`,常开是选择不是默认)。决策①不用你拍,P1 拍。
