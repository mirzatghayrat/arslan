...
<p align="center"><a href="docs/assets/arslan-demo.mp4"><b>▶ 58 秒のプロダクトツアーを見る</b></a> — リクエストの流れ、スポーン台帳、昇格ゲート、セカンドブレイン、そしてサンドボックス。<br><sub>画面録画ではなく、レンダリングした解説映像です。ソース: <a href="video/">video/</a></sub></p>
