...
def test_upflow_writes_userfact(maker, monkeypatch):
    from server.services import distill_service
...
def test_upflow_empty_reply_writes_nothing(maker, monkeypatch):
    from server.services import distill_service
...
def test_upflow_dedup_skips_existing(maker, monkeypatch):
    from server.services import distill_service
...
def test_upflow_empty_new_facts_noop(maker, monkeypatch):
    from server.services import distill_service
    calls = {"n": 0}
