...
async def test_migration_0011_adds_columns(tmp_path):
...
async def test_host_enabled_defaults_false(tmp_path):
    ...
    async with maker() as s:
        ...
        host_enabled = t.host_enabled
    assert host_enabled in (False, 0, None)   # default falsey
